...
add_action('genesis_footer', function() {
	...
	<section class="page-content-section footer turquoise-bg center">
		...
		<div class="wrap flex-container">
			...
			<div class="footer__block flex-child">
				...
				<?php if(get_field('e-mail', 'option') ) { ?>
					...
					<div class="footer__info__link footer__info__link--email bold">
					
						E-mail: <a class="info_email" href="mailto:<?= get_field('e-mail', 'option') ?>"><span class="thin"><?= get_field('e-mail', 'option') ?></span></a>
				...
				<?php if(get_field('adress', 'option')) { ?>
					...
					<div class="footer__info__adress bold">
						
						Adress: <span class="thin"><?= get_field('adress', 'option') ?></span>
				...
				<?php if(get_field('org_number', 'option')) { ?>
					...
					<div class="footer__info__org bold">
						
						Org.nummer: <span class="thin"><?= get_field('org_number', 'option') ?></span>
